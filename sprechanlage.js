...
(function () {
  ...
  var IMG = '../PLP/Product%20Image/Sprechanlage/video-station.png';
  ...
  /* ---- Subcategory rail ---- */
  var SP = '../PLP/Product%20Image/Sprechanlage/';
  var SUBCATS = [
  ...
  var PRODUCTS = [
    { id:'dominik1', name:'XDM10 Video-Türsprechanlage mit austauschbarem Namensschild | 2-Draht-BUS | 1 Klingeltaster | Maxior', line:'BUS-System', price:424.15, uvp:499.00, rating:5, reviews:2,
      badge:SALE, showMeta:true, award:'../PLP/Badge/reddot-award-badge.svg', colors:['anthrazit','eisenglimmer','grau','schwarz','weiss','wunschfarbe'], system:'bus', klingel:'1', tuer:[], type:'video', img:I83 },
  ...
  function card(p) {
    ...
    var awardBadge = p.award ? '<img class="pcard__award-badge" src="../PLP/Badge/reddot-award-badge.svg" alt="Red Dot Award winner 2026">' : '';
      ...
      '<section class="hero-banner hero-banner--inline" aria-label="XDM10 Video-Türsprechanlage">' +
        ...
        '<div class="hero-banner__stage" aria-hidden="true">' +
          '<div class="hero-banner__device">' +
            ...
            '<img class="hero-banner__award" src="../PLP/Badge/reddot-award-lockup.svg" alt="Red Dot Award Winner 2026">' +
          '</div>' +
        '</div>' +
      '</section>';
    return b;
